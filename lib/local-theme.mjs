...
// drift where a pulled layer/ file was silently dropped from the next push).
export const THEME_DIRS = new Set(["layout", "section", "block", "layer", "partial", "asset", "template"]);
