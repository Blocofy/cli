 ...
 * CF-T1: `--keychain` (login) ve `--adopt` (link) de değersizdir.
 */
const BOOLEAN_FLAGS = new Set(["draft", "live", "yes", "confirm", "no-sync", "dry", "dry-run", "validate", "diff", "help", "version", "api-key", "json", "strict", "write", "keychain", "adopt"]);
